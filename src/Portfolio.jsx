  ...
  en: {
    ...
    caps: {
      ...
      items: [
        ...
        { n: "03", t: "AI", d: "LLM integration, RAG, tool using agents. Shipped with cost, latency and failure cases already handled." },
    ...
    work: {
      title: "Featured work",
      label: "Five products, five different problems",
      items: [
        {
          n: "01",
          title: "GoodWorker",
          tagline: "Building a product from zero",
          meta: "Personal SaaS · Founder & Engineer · 2024 → now",
          intro: "A mobile marketplace connecting homeowners with construction professionals. Product vision, architecture, backend, mobile app, UX. Designed and built solo.",
          points: [
            "iOS and Android app in React Native (Expo), with real time messaging and appointment booking.",
            "An AI agent reads the request written in plain language, pulls out the real need and fills in the quote for the professional.",
            "Quotes and invoices generated automatically, ahead of the September 2026 e-invoicing mandate in France.",
            "One account, two profiles: professional and private, covering the whole cycle from request to job to invoice.",
          ],
          stack: ["React Native (Expo)", "Node.js", "Python", "MongoDB", "LLM", "WebSocket"],
          note: "iOS and Android release planned for winter 2026",
        },
        {
          n: "02",
          ...
          stack: ["Node.js", "TypeScript", "REST", "Webhooks", "MongoDB", "AWS CloudWatch"],
        },
        {
          n: "03",
          title: "Click N Controle",
          ...
          stack: ["Node.js", "Microservices", "GraphQL", "ElasticSearch", "Docker", "GitLab CI"],
        },
        {
          n: "04",
          title: "MyHotelMatch",
          ...
          stack: ["React Native", "TypeScript", "Python", "React", "GitLab CI"],
        },
        {
          n: "05",
          title: "Knap",
          ...
          intro: "Smart retail carts with fraud prevention built in. The hardware streams live data, AI agents read it, and the interface reacts in the store in real time.",
          chain: ["Connected hardware", "Real time data", "AI agents", "Fraud prevention"],
          points: [
          ...
          stack: ["JavaScript", "Node.js", "Real time APIs", "AI agents"],
        },
      ],
    },
    tools: {
    ...
    education: {
      label: "Education",
      items: [
        ["LLM, RAG & AI agents", "ongoing, already applied in production on GoodWorker"],
    ...
    contact: {
      title: "The fastest way in is to tell me the problem.",
      text: "Describe the situation and I will tell you straight whether I am the right person for it.",
      email: "Email",
      linkedin: "LinkedIn",
      phone: "Phone",
      form: {
  ...
  fr: {
    ...
    caps: {
      ...
      items: [
        ...
        { n: "03", t: "IA", d: "Intégration de LLM, RAG, agents outillés. Livrés avec le coût, la latence et les cas d'échec déjà traités." },
    ...
    work: {
      title: "Projets clés",
      label: "Cinq produits, cinq problèmes différents",
      items: [
        {
          n: "01",
          title: "GoodWorker",
          tagline: "Construire un produit à partir de zéro",
          meta: "SaaS personnel · Fondatrice & ingénieure · 2024 → aujourd'hui",
          intro: "Plateforme mobile qui met en relation particuliers et professionnels du bâtiment. Vision produit, architecture, backend, application, UX. Conçue et développée seule.",
          points: [
            "Application iOS et Android en React Native (Expo), avec messagerie et prise de rendez vous en temps réel.",
            "Un agent IA lit la demande écrite en langage naturel, en sort le besoin réel et remplit le devis côté professionnel.",
            "Devis et factures générés automatiquement, en anticipation de la facturation électronique obligatoire de septembre 2026.",
            "Un compte, deux profils : professionnel et particulier, avec tout le cycle de la demande à l'intervention puis à la facture.",
          ],
          stack: ["React Native (Expo)", "Node.js", "Python", "MongoDB", "LLM", "WebSocket"],
          note: "Sortie iOS et Android prévue hiver 2026",
        },
        {
          n: "02",
          title: "Flix Group & Corporate",
        ...
        },
        {
          ...
          meta: "Full Stack Engineer · 2024",
          intro: "Chariots connectés avec prévention de la fraude intégrée. Le hardware envoie des données en continu, des agents IA les lisent, et l'interface réagit en magasin en temps réel.",
          chain: ["Hardware connecté", "Données temps réel", "Agents IA", "Prévention de la fraude"],
          points: [
          ...
          stack: ["JavaScript", "Node.js", "API temps réel", "Agents IA"],
        },
      ],
    },
    tools: {
    ...
    education: {
      label: "Formation",
      items: [
        ["LLM, RAG & agents IA", "en cours, déjà appliqué en production sur GoodWorker"],
    ...
    contact: {
      title: "Le plus rapide, c'est de me raconter le problème.",
      text: "Décrivez la situation et je vous réponds franchement si je suis la bonne personne pour ça.",
      email: "E-mail",
      linkedin: "LinkedIn",
      phone: "Téléphone",
      form: {
